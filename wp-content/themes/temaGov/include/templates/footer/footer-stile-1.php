<div id="line_widget_footer" style="margin-bottom:15px;" class="row align-items-center">
    <div class="col-sm-1"></div>
    <div class="col-sm-6<?php echo ottieniClasseNoPaddingLeft(); ?>">
        <?php
    ...
    <div class="col-sm-16">
        <div class="subfooter">
            <div class="text-center">
                <div id="loghiW3C">
                    <a href="https://validator.w3.org/nu/?doc=https://<?php echo $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"]; ?>" target="_blank" title="HTML 5 Valido!"><img src="<?php echo madisoft_scuola_get_assets_directory('img'); ?>valid-xhtml10.png" alt="XHTML5 Valido!"/></a>&nbsp;
                    <a href="http://jigsaw.w3.org/css-validator/validator?uri=https://<?php echo $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"]; ?>" target="_blank" title="CSS Valido!"><img src="<?php echo madisoft_scuola_get_assets_directory('img'); ?>vcss-blue.gif" alt="CSS Valido!"/></a>
                    <?php
...
<div class="row">
    <div class="col-sm-1"></div>
    <div class="col-sm-<?php echo (MadisoftScuolaWidth::MADISOFT_WIDTH_1_2 -1) . ottieniClasseNoPaddingLeft(); ?>">
        <?php
        get_template_part ( 'include/templates/menu-social');
        ?>
    </div>
    <div class="col-sm-<?php echo (MadisoftScuolaWidth::MADISOFT_WIDTH_1_2-1); ?>">
        <?php
